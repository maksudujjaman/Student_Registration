                        ...
                        <div class="card-body">
                            <form action="{{ route('student.update', ['id' => $student->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" id="student_id" name="student_id" class="form-control" value="{{ $student->student_id }}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="student_name" name="name" class="form-control" value="{{$student->name}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" id="student_email" name="email" class="form-control" value="{{$student->email}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" id="student_mobile" name="mobile" class="form-control" value="{{$student->mobile}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="file" id="student_image" name="image" accept="image/*" class="form-control" value="{{$student->image}}"/>
